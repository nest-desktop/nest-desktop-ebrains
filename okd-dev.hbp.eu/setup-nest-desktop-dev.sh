...
oc new-app nestdesktop/app:dev+nestdesktop/nest-server:dev+nestdesktop/apache2-oidc:1.2
oc new-app nest-desktop-apache2oidc-collab2-dev.yaml
oc set env --from='configmap/nest-desktop-apache2oidc' dc/app
oc create route edge --hostname='nest-desktop.apps-dev.hbp.eu' --port='8080-tcp' --service='app'
